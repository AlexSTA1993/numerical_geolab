...
def test_all():
    ...
    testmodules = [     
        # Materials
        'ngeoFE_unittests.Materials.DruckerPrager_tests_0',
        'ngeoFE_unittests.Materials.Viscoplastic_DP_tests_0',
        'ngeoFE_unittests.Materials.Asym_CamClay_tests_0',
        'ngeoFE_unittests.Upscaling.SuperMaterials_tests_0',
        ...
        'ngeoFE_unittests.Mechanics.Cauchy.TwoD.Tests.Cauchy2D_Von_Mises_Perzyna_tests_App_2',  # This is a long test
        ...
        'ngeoFE_unittests.Mechanics.Cosserat.OneD.Tests.Cosserat1D_Drucker_Prager_tests_App_2',  # This is a long test

        # Multiphysiscs -- Cauchy
        ...
        'ngeoFE_unittests.Multiphysics.Cauchy_tests.ThreeD.Tests.Cauchy3D_ThermoHydroelasticity_tests_0',  # This is a long test
        'ngeoFE_unittests.Multiphysics.Cauchy_tests.ThreeD.Tests.Cauchy3D_Thermoplasticity_tests_0',

        # Multiphysiscs -- Cosserat
