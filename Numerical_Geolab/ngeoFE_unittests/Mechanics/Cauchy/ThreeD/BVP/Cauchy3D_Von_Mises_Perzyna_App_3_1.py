...
class Cauchy3DFEproblem(UserFEproblem):
    ...
    def create_mesh(self):
        ...
        mesh = BoxMesh(Point(-h/2.,-w/2.,-z/2.),Point(h/2.,w/2.,z/2.),self.ny,self.nw,self.nz)#"crossed")
    ...
    def run_analysis_procedure(self,reference_data_path):
        saveto=reference_data_path+"./Cauchy_3D_Von_Mises_Imperfection_step_0"+'_'+str(self.imp)+".xdmf"
        self.problem_step = 0
