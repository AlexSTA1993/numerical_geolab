...
class Cauchy3DFEproblem(UserFEproblem):
    ...
    def run_analysis_procedure(self,reference_data_path):
        saveto=reference_data_path+"./Cauchy_3D_Von_Mises_test_step_0.xdmf"
        self.problem_step = 0
        ...
        for i in range(nsteps):
            ...
            saveto= reference_data_path+"./Cauchy_3D_Von_Mises_test_step_"+str(i+1)+".xdmf"
            converged=self.solve(saveto,summary=True)
