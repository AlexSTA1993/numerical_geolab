...
'''
import unittest
from ngeoFE_unittests.Mechanics.Cauchy.ThreeD.BVP.Cauchy3D_Von_Mises_Perzyna_App_3 import Cauchy3DFEformulation, Cauchy3DFEproblem
...
class Test(unittest.TestCase):
    ...
    def test_shear_force_displacement_values(self):
        ...
        with open(reference_data_path+"Cauchy3D_Perzyna_force_disp_values_App_3.out", "wb") as fp:   #Pickling
            pickle.dump(values1,fp)        
        
        with open(reference_data_path+"Cauchy3D_Perzyna_force_disp_values_App_3.out", "rb") as fp:   #Pickling
    ...
    def test_analytical__yield_stress(self):  
        ...
        with open(reference_data_path+"/Cauchy3D_elasto-viscoplastic_stress_App3.out", "wb") as fp:   #Pickling
            pickle.dump(values,fp)    
        
        with open(reference_data_path+"/Cauchy3D_elasto-viscoplastic_stress_App3.out", "rb") as fp:   #Pickling
            values_ref=pickle.load(fp)        
