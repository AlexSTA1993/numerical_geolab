...
import unittest
from ngeoFE_unittests.Mechanics.Cauchy.ThreeD.BVP.Cauchy3D_Von_Mises_Perzyna_App_3_1 import Cauchy3DFEformulation, Cauchy3DFEproblem
...
class Test(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        imperfection1=0.1
        cls.my_FEproblem1=Cauchy3DFEproblem(cls.my_FEformulation,imperfection1)
        ...
        imperfection2=0.05
        cls.my_FEproblem2=Cauchy3DFEproblem(cls.my_FEformulation,imperfection2)
    ...
    def test_shear_force_displacement_values(self):
        ...
        with open(reference_data_path+"Cauchy3D_Perzyna_force_disp_values_App_3_1.out", "wb") as fp:   #Pickling
            pickle.dump(values1,fp)        
        
        with open(reference_data_path+"Cauchy3D_Perzyna_force_disp_values_App_3_1.out", "rb") as fp:   #Pickling
    ...
    def test_identical_elastoplastic_matrix(self):  
        ...
        with open(reference_data_path+"Cauchy3D_Perzyna_elastoplastic_modulo_App_3.out", "wb") as fp:   #Pickling
            pickle.dump(values, fp)  
    
        #read data from binary files
        with open(reference_data_path+"Cauchy3D_Perzyna_elastoplastic_modulo_App_3.out", "rb") as fp:   #Pickling
            values_ref=pickle.load(fp)        
    ...
    def test_analytical__yield_stress(self):  
        ...
        with open(reference_data_path+"/Cauchy3D_elasto-viscoplastic_stress_App3_1.out", "wb") as fp:   #Pickling
            pickle.dump(values,fp)    
        
        with open(reference_data_path+"/Cauchy3D_elasto-viscoplastic_stress_App3_1.out", "rb") as fp:   #Pickling
            values_ref=pickle.load(fp)        
    ...
    def test_localization_width_values(self):
        ...
        nf1=0+6*self.my_FEproblem1.ny#-2
        nf2=0+6*self.my_FEproblem2.ny#-2
        ...
        plotting_params.show_plot()
        plotting_params.plot_legends(ngeo_parameters.reference_data_path, fig, filename='Cauchy_3D_viscoplastic_App_3_1_x_ldot',mode='1')
