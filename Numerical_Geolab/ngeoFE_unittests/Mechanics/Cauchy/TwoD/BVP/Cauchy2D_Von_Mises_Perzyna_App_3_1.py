...
'''
import sys
# sys.path.insert(0,'/home/astathas2019/Alexsta_dev/lib/python3.8/site-packages/')
print(sys.path)
...
class Cauchy2DFEproblem(UserFEproblem):
    ...
    def create_mesh(self):
        ...
        self.ny=100#80
        self.nw=1
        mesh = RectangleMesh(Point(-h/2.,-w/2.),Point(h/2.,w/2.),self.ny,self.nw,"left")#"crossed")
    ...
    def history_svars_output(self):
        ...
        hist_svars=[
                    [1,[1,[21]]]
                    ] #Calculate elastoviscoplastic shear strain increment
        return hist_svars    
    ...
    def set_materials(self):
        ...
        umat_id=2       # described a 2D material
    ...
    def set_material_1_properties(self,EE,nu,cc):
        ...
        props[2-1]=GG
        props[12-1]=cc
        props[15-1]=-0.5 #strain softening
    ...
    def run_analysis_procedure(self,reference_data_path):
        ...
        for i in range(nsteps):
            ...
            saveto= reference_data_path+"./Cauchy_2D_Von_Mises_Imperfection_step_"+str(i+1)+'_'+str(self.imp)+".xdmf"
            converged=self.solve(saveto,summary=True)
