...
class Cauchy2DFEproblem(UserFEproblem):
    ...
    def run_analysis_procedure(self,reference_data_path):
        saveto=reference_data_path+"./Cauchy_2D_Von_Mises_Perzyna_App1_test_step_0.xdmf"
        self.problem_step = 0
        ...
        for i in range(nsteps):
            ...
            saveto= reference_data_path+"./Cauchy_2D_s_Perzyna_App1_test_step_"+str(i+1)+".xdmf"
            converged=self.solve(saveto,summary=True)
