...
class Cauchy1DFEproblem(UserFEproblem):
    ...
    class Gauss_point_Querry(SubDomain):
        ...
        def inside(self, x, on_boundary):
            ...
            return between(x[0], (-self.h/(self.ny),self.h/(self.ny)))
    ...
    def set_bcs(self):
        ...
        if self.problem_step == 0:
            bcs=[
                ...
                [2,[0,[1],0.]],#self.Normal_loading_total

                [1,[2,[0],0.]],
                [1,[0,[1],0.]],#self.Normal_loading_total
                ]
    ...
    def run_analysis_procedure(self,reference_data_path):
        saveto=reference_data_path+"Cauchy_1D_Drucker-Prager_test_step_0"+"_App_1"+".xdmf"
        self.problem_step = 0
...
#         print('tmax', my_FEproblem.slv.tmax)
            filename = 'Cauchy_1D_Drucker-Prager_test_step_'+str(i+1)
            saveto= reference_data_path+"Cauchy_1D_Drucker-Prager_test_step_"+str(i+1)+"_App_1"+".xdmf"
            converged=self.solve(saveto,summary=True)
