...
'''
import unittest
from ngeoFE_unittests.Mechanics.Cauchy.OneD.BVP.Cauchy1D_Von_Mises_Perzyna_App_1 import Cauchy1DFEformulation, Cauchy1DFEproblem
...
class Test(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.my_FEproblem2=Cauchy1DFEproblem(cls.my_FEformulation)
    ...
    def test_shear_force_displacement_values(self):
        ...
        with open(reference_data_path+"/Cauchy1D_Perzyna_force_disp_values_App_1.out", "wb") as fp:   #Pickling
            pickle.dump(values, fp)
        #read data from binary files
        with open(reference_data_path+"/Cauchy1D_Perzyna_force_disp_values_App_1.out", "rb") as fp:   #Pickling
        ...
        if equal:
            ...
            plotting_params.plot_legends(ngeo_parameters.reference_data_path, fig, filename='Cauchy_1D_Perzyna_visoplasticity_App_1_sigma_u_new',mode='1')
    ...
    #     with open(ngeo_parameters.reference_data_path+"Cauchy1D_Perzyna_elastoplastic_modulo_App_1.out", "wb") as fp:   #Pickling
    #         pickle.dump(values, fp)  
    #     #read data from binary files
    #     with open(reference_data_path+"Cauchy1D_Perzyna_elastoplastic_modulo_App_1.out", "rb") as fp:   #Pickling
    #         values_ref=pickle.load(fp)        
    #     values_diff=values_ref-values
    #
    #     equal=abs(np.linalg.norm(values_diff))<=1.e-13
    ...
    def test_analytical__yield_stress(self):  
        ...
        with open(reference_data_path+"/Cauchy1D_elasto-viscoplastic_stress_App1.out", "wb") as fp:   #Pickling
            pickle.dump(values,fp)    
    
        with open(reference_data_path+"/Cauchy1D_elasto-viscoplastic_stress_App1.out", "rb") as fp:   #Pickling
            values_ref=pickle.load(fp)        
