...
'''
import unittest
from ngeoFE_unittests.Mechanics.Cauchy.OneD.BVP.Cauchy1D_Von_Mises_Perzyna_App_3_1 import Cauchy1DFEformulation, Cauchy1DFEproblem
import pickle
import numpy as np
...
class Test(unittest.TestCase):
    ...
    def test_shear_force_displacement_values(self):
        ...
        with open(reference_data_path+"Cauchy1D_Perzyna_force_disp_values_App_3_1.out", "wb") as fp:   #Pickling
            pickle.dump(values1,fp)        
        
        with open(reference_data_path+"Cauchy1D_Perzyna_force_disp_values_App_3_1.out", "rb") as fp:   #Pickling
        ...
        if equal:
            ...
            plotting_params.plot_legends(ngeo_parameters.reference_data_path, fig, filename='Cauchy_1D_Perzyna_visoplasticity_App_3_1_sigma_t',mode='1')
            ...
            # plotting_params.plot_legends('./reference_data/', fig, ax,legend_title=' ', filename='Cauchy_2D_Perzyna_elastoplastic_App3_s_u',mode='1')
            # fig, ax1, ax2, color1, color2 = plotting_params.object_plot_axes('$u$ [mm]', y1_txt='$\sigma$ [kPa]',color1='',y2_txt='$\sigma$ [kPa]',color2='', title='',mode='2')
            ...
            plotting_params.show_plot()
            plotting_params.plot_legends(ngeo_parameters.reference_data_path, fig, filename='Cauchy_1D_Perzyna_visoplasticity_App_3_1_sigma_u',mode='1')
    ...
    def test_analytical__yield_stress(self):  
        ...
        with open(reference_data_path+"/Cauchy1D_elasto-viscoplastic_stress_App3_1.out", "wb") as fp:   #Pickling
            pickle.dump(values,fp)    
        
        with open(reference_data_path+"/Cauchy1D_elasto-viscoplastic_stress_App3_1.out", "rb") as fp:   #Pickling
            values_ref=pickle.load(fp)        
    ...
    def test_localization_width_values(self):
        ...
        # print(ldot_values_over_line.shape)
        ...
        # print(np.array(self.my_FEproblem1.feobj.svars_coordinates[0:nf1])[:,0].shape)
        # print(np.array(self.my_FEproblem2.feobj.svars_coordinates[0:nf2])[:,0].shape)
        ...
        # for i in range(ldot_values_over_line_2.shape[0]):
        #     # for j in range(ldot_values_over_line_2.shape[1]):
        #     print(ldot_values_over_line_2[i,:])
        # print(np.array(self.my_FEproblem1.feobj.svars_coordinates))
        # print(np.array(self.my_FEproblem2.feobj.svars_coordinates))
        ...
        plotting_params.show_plot()
        plotting_params.plot_legends(ngeo_parameters.reference_data_path, fig, filename='Cauchy_1D_viscoplastic_App_3_1_x_ldot',mode='1')
