...
class Cosserat1DFEproblem(UserFEproblem):
    ...
    """
    def __init__(self,FEformulation,nw):
    ...
    def history_svars_output(self):
        ...
        hist_svars=[[1,[1,[0]]], #sigma_11
                    ...
                    [1,[1,[34]]], #kappa_32
                    [1,[1,[35]]], #kappa_33
                    [1,[1,[57]]], #lambda_dot #2 plot over line
                    [2,[1,[57]]], #lambda_dot #2 plot over line
                    [2,[1,[15]]], #mu_31 #2 plot over line
                    [2,[1,[11]]], #mu_13 #2 plot over line
                    [2,[1,[1]]], #tau_12 #2 plot over line
                    [2,[1,[3]]], #tau_21 #2 plot over line
                    ]
        return hist_svars    
    ...
    def run_analysis_procedure(self,reference_data_path):
        saveto=reference_data_path+"Cosserat_1D_Drucker-Prager_test_step_0"+"_App_2"+str(self.nw)+".xdmf"
        self.problem_step = 0
        ...
        for i in range(nsteps):
            ...
            saveto= reference_data_path+"Cosserat_1D_Drucker-Prager_test_step_"+str(i+1)+"_App_2"+str(self.nw)+".xdmf"
            converged=self.solve(saveto,summary=True)
    ...
    def extract_force_disp(self):
        ...
        self.array_force=self.array_force[:,:]
        self.array_disp=self.array_disp[:,:]
        return
