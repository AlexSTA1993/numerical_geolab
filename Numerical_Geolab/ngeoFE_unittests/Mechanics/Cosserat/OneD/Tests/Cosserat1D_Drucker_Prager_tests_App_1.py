...
class Test(unittest.TestCase):
    ...
    def test_shear_force_displacement_values(self):
        ...
        # with open(reference_data_path+"Cosserat1D_Drucker_Prager_force_disp_values_App_1.out", "wb") as fp:   #Pickling
        #     pickle.dump(values1,fp)        
        

        with open(reference_data_path+"Cosserat1D_Drucker_Prager_force_disp_values_App_1.out", "rb") as fp:   #Pickling
        ...
        # with open(reference_data_path+"Cosserat1D_Drucker_Prager_svars_values_App_1_1.out", "wb") as fp:   #Pickling
        #     pickle.dump(svars_values,fp)        
    
        with open(reference_data_path+"Cosserat1D_Drucker_Prager_svars_values_App_1_1.out", "rb") as fp:   #Pickling
    ...
    def test_analytical__lambda_dot(self):  
        ...
        values_error_abs= np.where(lambda_dot_calc>10**(-8),error_an, 0)#[indices]
        values_error_rel= np.where(lambda_dot_calc,error_rel, 0)#[indices]
