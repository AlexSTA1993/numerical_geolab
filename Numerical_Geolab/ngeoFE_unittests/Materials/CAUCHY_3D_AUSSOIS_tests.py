...
#         print('I am inside Test')
        ...
        stress_total=[]; press_fluid=[]; T=[]; sigma22s=[]; epsilon22s=[]
...
#             print(stressGP_t,"alex \n",svarsGP_t)
            if nill!=1:
                ...
                stress_total.append(stressGP_t.tolist())
                ...
                epsilon22s.append(svarsGP_t[13])
...
#         print(len(stress_total))
        ...
        plt.plot(evs, stress_total, "g+-", label="$\sigma^{tot}_{22}-\epsilon_v$")
        plt.plot(evs, sigma22s, "k^-", label="$\sigma^{eff}_{22}-\epsilon_v$")
...
#         plt.plot(epsilon22s, sigma22s, "bo-", label="$\sigma^{eff}_{22}-\epsilon_{22}$")
#         plt.plot(epsilon22s, stress_total, "g+-", label="$\sigma_{22}-\epsilon_{22}$")
