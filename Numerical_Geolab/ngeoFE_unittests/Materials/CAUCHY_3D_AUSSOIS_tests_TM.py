...
'''
# from examples.0test_cauchy1Dmat import svars
...
#     conductivity = 2.8*10.**(0.)
    ...
    fluid_viscocity = 1.;bstar=10.**6;#8.2*10.**(-5.) ;
    permeability1 = 1.
    permeability = permeability1/bstar
    alpha =1.*10**-2; lstar = 0.;
    rhoC = 1.;
    conductivity = 1.
...
#         e11min=0.;e11max=.1;deps11=(e11max-e11min)/increments
        ...
        qHy22min=0.;qHy22max=0.;dqHyeps22=(qHy22max-qHy22min)/increments
...
#             print(stressGP_t,"alex \n",svarsGP_t)
            if nill!=1:
                ...
                stress_total.append(stresstotal(stressGP_t))
                press_fluid.append(pf(svarsGP_t))
