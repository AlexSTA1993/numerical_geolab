...
#         imperfection.mark(subdomains,1)
    ...
    def set_material_1_properties(self):
        ...
        conductivity = 1.; rhoC = 1; alpha =0.; lstar = 0.*10.**8.;
    ...
    def run_analysis_procedure(self,reference_data_path):
        saveto=reference_data_path+"/HYDRO-ELASTIC/Cosserat_1D_Drucker-Prager_HE_test_step_0"+"_App_1_"+str(self.nw)+".xdmf"
        self.problem_step = 0
        ...
        for i in range(nsteps):
            ...
            self.feobj.initBCs()
            saveto= reference_data_path+"/HYDRO-ELASTIC/Cosserat_1D_Drucker-Prager_HE_test_step_"+str(i+1)+"_App_1_"+str(self.nw)+".xdmf"
            converged=self.solve(saveto,summary=True)
