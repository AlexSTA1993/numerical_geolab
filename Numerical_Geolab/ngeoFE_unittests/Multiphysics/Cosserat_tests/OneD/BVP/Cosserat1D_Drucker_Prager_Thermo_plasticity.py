...
#
    ...
    def set_material_1_properties(self):
        ...
        MG=G*(R**2.)/h3 ; MGc=MG;         
        permeability = 1.;fluid_viscocity = 1.;bstar=1.*10.**16.;
    ...
    def run_analysis_procedure(self,reference_data_path):
        saveto=reference_data_path+"/THERMO-PLASTIC/Cosserat_1D_Drucker-Prager_THM_test_step_0"+"_App_1_"+str(self.nw)+".xdmf"
        self.problem_step = 0
        ...
        for i in range(nsteps):
            ...
            saveto= reference_data_path+"/THERMO-PLASTIC/Cosserat_1D_Drucker-Prager_THM_test_step_"+str(i+1)+"_App_1_"+str(self.nw)+".xdmf"
            converged=self.solve(saveto,summary=True)
