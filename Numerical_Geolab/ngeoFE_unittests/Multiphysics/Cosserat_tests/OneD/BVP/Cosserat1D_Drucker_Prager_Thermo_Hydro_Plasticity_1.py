...
class CosseratTHM1DFEproblem(UserFEproblem):
    ...
    def set_bcs(self):
        ...
        if self.problem_step == 0:
            ...
            bcs = [
                ...
                [2, [0, [0,0], -self.u1_tot/self.scale_u]],
                [2, [0, [0,1], 0.]],
                [2, [1, [1], 0.]],
                [2, [1, [2,0], 0.]],
                [2, [1, [2,1], 0.]],                
    ...
    def set_material_1_properties(self):
        ...
        conductivity = 1; rhoC = 1; alpha =0.; lstar = 1.;
    ...
    def run_analysis_procedure(self,reference_data_path):
        saveto=reference_data_path+"/THERMO-HYDRO-PLASTIC/Cosserat_1D_Drucker-Prager_THM_un_comp_test_step_0"+"_App_1_"+str(self.nw)+".xdmf"
        self.problem_step = 0
        ...
        for i in range(nsteps):
            ...
            self.feobj.initBCs()
            saveto= reference_data_path+"/THERMO-HYDRO-PLASTIC/Cosserat_1D_Drucker-Prager_THM_un_comp_test_step_"+str(i+1)+"_App_1_"+str(self.nw)+".xdmf"
            converged=self.solve(saveto,summary=True)
