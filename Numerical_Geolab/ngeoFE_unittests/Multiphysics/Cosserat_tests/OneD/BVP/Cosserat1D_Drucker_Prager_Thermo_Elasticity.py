...
class CosseratTHM1DFEproblem(UserFEproblem):
    ...
    def set_material_1_properties(self):
        ...
        permeability1 = 1.;fluid_viscocity = 1.;bstar=1.*10.**12.;
        permeability = permeability1/bstar
        conductivity = 10.**8; rhoC = 10.**8; alpha =1.; lstar = 0.*10.**8.;
        
        tanfi=0.5; cc=100000000.;
    ...
    def run_analysis_procedure(self,reference_data_path):
        saveto=reference_data_path+"/THERMO-ELASTIC/Cosserat_1D_Drucker-Prager_TE_test_step_0"+"_App_1_"+".xdmf"
        self.problem_step = 0
        ...
        for i in range(nsteps):
            ...
            self.feobj.initBCs()
            saveto= reference_data_path+"/THERMO-ELASTIC/Cosserat_1D_Drucker-Prager_TE_test_step_"+str(i+1)+"_App_1_"+".xdmf"
            converged=self.solve(saveto,summary=True)
