...
# from ngeoFE_unittests.Multiphysics import ngeo_parameters
...
#               #right
    ...
    def set_material_1_properties(self):
        ...
        permeability1 = 1.;fluid_viscocity = 1.;bstar=1;
        permeability = permeability1/bstar
        conductivity = 1.; rhoC = 1; alpha =2.5*10.**-5.; lstar = 1.;
...
#         print(self.feobj.problem_history)
        for g in self.feobj.problem_history:
            if int(g[0]) % int(10) == int(0):
                ...
                self.temperature.append(g[2][0])
#         print(a)    
#         print(b)
        self.temperature = np.array(self.temperature) 
        fig, ax = plt.subplots()
        ax.plot(self.time,self.temperature,markersize=6,color='blue',marker='+',label ='pressure at right end')
    ...
    def give_me_solver_params(self):
        ...
        self.slv.dtmax=10.
        self.slv.tmax=500.
        filename='test1D_Hydroelasticity'
