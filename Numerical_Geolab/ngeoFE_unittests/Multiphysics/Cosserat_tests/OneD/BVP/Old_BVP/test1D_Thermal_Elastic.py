...
#         props=props.astype("double")
        ...
        permeability1 = 10.**-8.;fluid_viscocity = 1.;bstar=10.**8.;
...
#         print(b)
        ...
        ax.set(xlabel='time (s)', ylabel='Temperature ($C$)',title='Temperature versus time at free end')
        ax.grid()
        plt.show()
...
#         ninc=int(self.slv.tmax/self.slv.dtmax)
        filename='test1D_Thermoelasticity'
