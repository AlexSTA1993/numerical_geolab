...
#         props=props.astype("double")
        ...
        K=4000.; G=4000.; Gc=2000. ; L=1000.;R=2.5; 
#         K=3.; G=1.5; Gc=1.5 ; L=1.;R=10.*10.**(-3.);  
        MG=G*(R**2.)/h3 ; MGc=MG; #th_g=0.; 
        permeability1 = 1.;fluid_viscocity = 1.;bstar=2.*10.**8.;
        permeability = permeability1/bstar
        conductivity = 0.5*10**-8; rhoC = 1; alpha =0.; lstar = 1.*10.**8.;
        tanfi=0.; cc=100.#*0000000.;
...
#         ninc=int(self.slv.tmax/self.slv.dtmax)
        filename='test1D_HydroThermalPlastic'
