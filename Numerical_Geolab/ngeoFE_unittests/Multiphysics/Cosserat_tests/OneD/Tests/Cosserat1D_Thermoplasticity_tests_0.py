...
import os
import unittest
from ngeoFE_unittests.Multiphysics.Cosserat_tests.OneD.BVP.Cosserat1D_Drucker_Prager_Thermo_plasticity import CosseratTHM1DFEformulation,CosseratTHM1DFEproblem
...
class Test(unittest.TestCase):
    ...
    def test_generalized_force_displacement_values(self):
        ...
        #with open(reference_data_path+"Cosserat1D_THM_Thermoplasticity.out", "wb") as fp:   #Pickling
        #    pickle.dump(values1,fp)        
    
        with open(reference_data_path+"Cosserat1D_THM_Thermoplasticity.out", "rb") as fp:   #Pickling
        ...
        if equal and activate_plots:
            ...
            plotting_params.plot_legends(ngeo_parameters.reference_data_path, fig, filename='Cosserat_1D_Thermoplasticity_1_T',mode='1')
            ...
            plotting_params.object_plot(x1, y1, "y1", ax1, 'ax2', mode='1',color1=color1,color2='color2',label_string='')
            plotting_params.show_plot()           
            plotting_params.plot_legends(ngeo_parameters.reference_data_path, fig, filename='Cosserat_1D_Thermoplasticity_1_u',mode='1')
            ...
            plotting_params.object_plot(x3, y2, y3, ax1, ax2, mode='2',color1=color1,color2=color2,label_string='')
            plotting_params.show_plot()                       
            
            plotting_params.plot_legends(ngeo_parameters.reference_data_path, fig, filename='Cosserat_1D_Thermoplasticity_sigma22_12',mode='1')
