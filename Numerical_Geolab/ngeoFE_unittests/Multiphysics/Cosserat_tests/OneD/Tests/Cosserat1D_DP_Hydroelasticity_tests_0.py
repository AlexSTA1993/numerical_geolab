...
import unittest
from ngeoFE_unittests.Multiphysics.Cosserat_tests.OneD.BVP.Cosserat1D_Drucker_Prager_Hydro_Elasticity import CosseratTHM1DFEformulation,CosseratTHM1DFEproblem
...
class Test(unittest.TestCase):
    ...
    def test_generalized_force_displacement_values(self):
        ...
        # with open(reference_data_path+"Cosserat1D_DP_THM_Hydroelasticity.out", "wb") as fp:   #Pickling
        #     pickle.dump(values1,fp)        

        with open(reference_data_path+"Cosserat1D_DP_THM_Hydroelasticity.out", "rb") as fp:   #Pickling
        ...
        if equal and activate_plots:
            ...
            y1=list(values_gen_disp1[:-1:step,-2].copy()[:-1])
            ...
            y2=analytical_pressure_values[:f_index,1]+66.67
            ...
            plotting_params.plot_legends(ngeo_parameters.reference_data_path, fig, filename='Cosserat_1D_Hydroelasticity_Pcalc_Panal',mode='1')
            ...
            plotting_params.show_plot()           
            plotting_params.plot_legends(ngeo_parameters.reference_data_path, fig, filename='Cosserat_1D_Hydroelasticity_u_anal',mode='1')
