...
import os
import unittest
from ngeoFE_unittests.Multiphysics.Cosserat_tests.OneD.BVP.Cosserat1D_Drucker_Prager_Thermo_Hydro_Plasticity import CosseratTHM1DFEformulation,CosseratTHM1DFEproblem
...
class Test(unittest.TestCase):
    ...
    def test_generalized_force_displacement_values(self):
        ...
        #with open(reference_data_path+"Cosserat1D_THM_Thermo_Hydro_plasticity.out", "wb") as fp:   #Pickling
        #    pickle.dump(values1,fp)        
    
        with open(reference_data_path+"Cosserat1D_THM_Thermo_Hydro_plasticity.out", "rb") as fp:   #Pickling
        ...
        if equal and activate_plots:
            ...
            plotting_params.object_plot(x1, y1, y2, ax1, ax2,x1,plot_mode='normal', mode='2',color1=color1,color2=color2, label_string='')

            plotting_params.show_plot()           
            plotting_params.plot_legends(ngeo_parameters.reference_data_path, fig, filename='Cosserat_1D_Thermo_Hydro_plasticity_simple_shear_T_P',mode='1')
            ...
            plotting_params.show_plot()           
            plotting_params.plot_legends(ngeo_parameters.reference_data_path, fig, filename='Cosserat_1D_Thermo_Hydro_plasticity__simple_shear_u',mode='1')
            ...
            fig, ax1, ax2, color1, color2 = plotting_params.object_plot_axes('$t$ [s]',y1_txt= '$\sqrt{J_2}$ [MPa]',color1='',y2_txt='$P^\prime$ [MPa]',color2='', title='',mode='2')
            
            plotting_params.object_plot(x1, y2, y3, ax1, ax2, plot_mode='normal', mode='2',color1=color1,color2=color2, label_string='')
            plotting_params.show_plot()
            plotting_params.plot_legends(ngeo_parameters.reference_data_path, fig, filename='Cosserat_1D_Thermo_Hydro_plasticity_simple_shear_J_2_P_eff',mode='1')
    ...
    def test_final_T_P(self):
        ...
        values_diff=self.P-self.T-self.my_FEproblem1.Pressure_loading
    ...
    def test_DT_DP_equality(self):
        ...
        self.evol_dt=values_gen_disp1[:,0]*self.my_FEproblem1.scale_u #10 number of increments
        
        lstar=self.my_FEproblem1.mats[0].props[13]
        bstar=self.my_FEproblem1.mats[0].props[9]
    
        values_diff=self.dP[1:]-lstar/bstar*self.dT[1:]+self.evol_dt[1:]/bstar
        ...
        if equal and activate_plots: 
            ...
            plotting_params.show_plot()
            plotting_params.plot_legends(ngeo_parameters.reference_data_path, fig, filename='Cosserat_1_Thermo_Hydro_plasticity_simple_shear_DT_DP',mode='1')
