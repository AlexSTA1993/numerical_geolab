...
'''
import unittest
from ngeoFE_unittests.Multiphysics.test1D_Thermo_Plastic_Cauchy import THM1D_FEformulation, THM1D_FEproblem
...
class Test(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        saveto=reference_data_path+"./test1D_Thermo_Plastic_CAUCHY1.xdmf"  
