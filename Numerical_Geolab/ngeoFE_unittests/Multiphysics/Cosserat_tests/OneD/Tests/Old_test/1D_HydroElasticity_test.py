...
import unittest
from ngeoFE_unittests.Multiphysics.Cosserat_tests.OneD.BVP.test1D_Hydro_Elastic import THM1D_FEformulation, THM1D_FEproblem
...
class Test(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        saveto=reference_data_path +"./test1D_HydroElasticity.xdmf"
...
#              pickle.dump(values, fp)
    ...
    def test_pressure_vs_volumetric_strain(self):
        values_diff=self.my_FEproblem.pressure_vs_volumetric_strain()
