...
sets initial conditions and performs a 3D isochoric triaxial test in elasto-plasticity.
'''
...
class THM3D_FEproblem(UserFEproblem):
    def __init__(self,FEformulation,PF):
        ...
        self.Pressure_loading=PF#66.66
    ...
    def set_bcs(self):
        ...
        if self.problem_step == 0:
            bcs=[
                [1,[0,[2],0.]],#self.Normal_loading_total
                [2,[0,[2],0.]],#self.Normal_loading_total
                [3,[0,[0],0.]],
                [4,[0,[0],0.]],
                [5,[0,[1],0.]],
                [6,[0,[1],0.]],
                
                [1,[0,[3],0.]],#self.Normal_loading_total
                [2,[0,[3],0.]],#self.Normal_loading_total
                [3,[0,[3],0.]],
                [4,[0,[3],0.]],
                [5,[0,[3],0.]],
                [6,[0,[3],0.]],
            ...
            bcs=[
                [1,[0,[2],-0.06]],#self.Normal_loading_total
                [2,[0,[2],0.]],#self.Normal_loading_total
                [3,[0,[0],0.]],
                [4,[0,[0],0.03]],
                [5,[0,[1],0.]],
    ...
    def set_material_1_properties(self):
        ...
        GG=EE/(2.*(1.+nu))
        KK=EE*GG/(3.*(3.*GG-EE))
        permeability=1.;fluid_viscosity=1.;lstar=1.;bstar=1.;alpha=0.
