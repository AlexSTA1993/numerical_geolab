...
BVP HydroPlasticity with a Cauchy continuum and a Drucker-Prager yield criterion, 
sets initial conditions and performs a 3D triaxial test in elasto-plasticity. The specimen lies under 1D compression,
with negative dispacement at the top boundary.
'''
...
class THM3D_FEproblem(UserFEproblem):
    def __init__(self,FEformulation):
        ...
        self.problem_step=0
        self.h = 1.
        self.Normal_loading_total_1=-200.
        self.Normal_loading_total_2=-200.
        self.Normal_loading_total_3=-200.

        self.Pressure_loading=66.66
        
        self.Normal_loading_eff_1=self.Normal_loading_total_1+self.Pressure_loading
        self.Normal_loading_eff_2=self.Normal_loading_total_2+self.Pressure_loading
        self.Normal_loading_eff_3=self.Normal_loading_total_3+self.Pressure_loading
    ...
    def set_initial_conditions(self):
        ...
        tmp[1-1]=self.Normal_loading_eff_1
        tmp[2-1]=self.Normal_loading_eff_2
        tmp[3-1]=self.Normal_loading_eff_3
        ...
        tmp[1-1]=self.Normal_loading_total_1 #specimen is in dry conditions total pressure equals effective pressure
        tmp[2-1]=self.Normal_loading_total_2
        tmp[3-1]=self.Normal_loading_total_3
    ...
    def set_material_1_properties(self):
        ...
        """
        EE=2000.;nu=0. ;cc=0. ;tanfi=0.5;tanpsi=0.;Hsfi=0.;Hscc=0.
        GG=EE/(2.*(1.+nu))
        KK=EE*GG/(3.*(3.*GG-EE))
        permeability=1.;fluid_viscosity=1.;lstar=0.;bstar=10.**(-1);alpha=0.
