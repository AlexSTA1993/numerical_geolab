...
BVP Thermo-Hydro-Plasticity with a Cauchy continuum and a Drucker-Prager yield criterion, 
...
class THM3D_FEproblem(UserFEproblem):
    ...
    def set_material_1_properties(self):
        ...
        """
        EE=2000.;nu=0. ;cc=0.0 ;tanfi=0.5;tanpsi=0.;Hsfi=0.;Hscc=0.
        GG=EE/(2.*(1.+nu))
        KK=EE*GG/(3.*(3.*GG-EE))
        permeability=1.;fluid_viscosity=1.;lstar=0.1;bstar=0.1;alpha=0.
