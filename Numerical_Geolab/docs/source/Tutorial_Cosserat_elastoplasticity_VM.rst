...
| Next we continue by generating the mesh for the problem at hand. Here, a 1D Cauchy layer is modeled as a bounded interval of length 1.
...
(my_FEproblem.slv.tmax) and the maximum number of increments (my_FEproblem.slv.nincmax=50). We introduce these parameters of the solution procedure 
